...
const CARDS_CONFIG = {
  noticias:     { icon: '◉', titulo: 'Noticias',          desc: 'Comunicados, avisos y novedades del proceso ET2023',  path: '/modules/noticias/noticias.html' },
  ...
  'revision-abogado': { icon: '◌', titulo: 'Revisión',       desc: 'Resoluciones de proyección y pago',              path: 'https://portal-cc-cne.onrender.com?rol=abogado' },
  'res-proyeccion':   { icon: '◫', titulo: 'Res. Proyección', desc: 'Resoluciones de proyección de reconocimiento',   path: 'https://portal-cc-cne.onrender.com?rol=abogado&doc=proyeccion' },
  'res-pago':         { icon: '◈', titulo: 'Res. Pago',       desc: 'Resoluciones de pago',                           path: 'https://portal-cc-cne.onrender.com?rol=abogado&doc=pago' },
  ...
  reportes:             { icon: '◫', titulo: 'Reportes',          desc: 'Generación y exportación de reportes del proceso ET2023',     path: '/modules/reportes/reportes.html' },
